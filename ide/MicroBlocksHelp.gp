...
method initialize MicroBlocksHelp {
	...
	opEntries = (array
		...
		(array 'REX line sensor' '/extension_libraries/rex/#rex-line-sensor' 'Returns (-o) if the line sensor detects a dark line.')
		...
		(array '_REX Arm new default' '/extension_libraries/rex/#_rex-arm-new-default' 'Sets DEFAULT values for the Arm servos.')
		(array '_REX Arm new maximum' '/extension_libraries/rex/#_rex-arm-new-max' 'Sets MAXIMUM values for the Arm servos.')
		(array '_REX Arm new minimum' '/extension_libraries/rex/#_rex-arm-new-min' 'Sets MINIMUM values for the Arm servos.')
		(array '_REX angleValid' '/extension_libraries/rex/#_rex-anglevalid' 'Returns (-o) if the selected angle is in the range of 0-180 degrees.')
		(array '_REX anglesOK servo' '/extension_libraries/rex/#_rex-anglesok-servo' 'Returns (-o) if the selected angle for a servo is within min & max. ')
