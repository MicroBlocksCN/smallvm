...
reload '../ide/MicroBlocksExchange.gp'
reload '../ide/MicroBlocksFilePicker.gp'
reload '../ide/MicroBlocksSpinner.gp'
reload '../ide/MicroBlocksFlasher.gp'
reload '../ide/MicroBlocksTipBar.gp'
reload '../ide/MicroBlocksHelp.gp'
reload '../ide/MicroBlocksHTTPServer.gp'
reload '../ide/MicroBlocksLibraryWidgets.gp'
reload '../ide/MicroBlocksProject.gp'
reload '../ide/MicroBlocksFinder.gp'
